...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(data){
    const commonAndScientific =[];
    data.forEach(function(item){
      commonAndScientific.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    })
    return commonAndScientific;
  }
  ...
  */
  ...
  function lowerCaseNames(data){
    const onlyLowerCase = data.map(item => item.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const onlyLowPop = data.filter(item => item.population < 5);
    return onlyLowPop;
  }
  ...
  */
  ...
  function thisAnimalEats(animals, food){
    return `${animals} eat ${food}`;
  }

  console.log('Callbacks Step 1: ', consume('Chickens', 'everything!', thisAnimalEats));
...
console.log('Topic 3 Step 1: ', cuboid1 );
...
console.log('Topic 3 Step 2: ', cuboid1.volume());
...
/* 🐴🐴🐴 Step 3: Surface Area Method 🐴🐴🐴
  ...
  console.log('Topic 3 Step 2: ', cuboid1.surfaceArea());
...
console.log('Test Stretch: ', cube.surfaceArea());
